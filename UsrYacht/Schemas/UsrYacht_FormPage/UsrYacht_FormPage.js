	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_qurdhgo_caption)#",
					"color": "default",
					"disabled": false,
					"size": "medium",
			...
			},
			{
				...
				"values": {
					...
					"clicked": {
						...
						"params": {
							"processName": "UsrCalcAverageTikectPriceProcess",
		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.PDS_UsrDriveType_hnamwkn;
					var driveTypeId = "";
					if (typeObject) {
