namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAverageTikectPriceProcessMethodsWrapper

	/// <exclude/>
	public class UsrCalcAverageTikectPriceProcessMethodsWrapper : ProcessModel
	{

		public UsrCalcAverageTikectPriceProcessMethodsWrapper(Process process)
			: base(process) {
